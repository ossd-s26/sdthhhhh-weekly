...
We also practiced some basic Git commands and workflows. For example, we learned how to create commits, check the status of a repository, and view the commit history. At first Git still feels a little confusing, but practicing these exercises helped me understand the workflow better.<!--more-->
